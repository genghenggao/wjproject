 ...
 * @LastEditors: henggao
 * @LastEditTime: 2021-07-11 11:17:09
-->
<template>
        ...
        <el-card shadow="never">
            ...
            <div class="content">
                <div class="content-header">
                    <el-row :gutter="20">
                        <el-col :span="4">
                            <el-input v-model="keyword" placeholder="请输入报表信息"></el-input>
                        </el-col>
                        <el-col :span="4">
                        ...
                        <el-col :span="4">
                            ...
                            <el-button type="primary" @click="addGoodsInfo">上传报表</el-button>
                        </el-col>
                    </el-row>
                </div>
                <div class="content-main">
                    <el-table :data="tableData" border stripe style="width: 100%; margin: 1em 0"
                        ...
                        <el-table-column prop="goodsId" label="报表ID" align="center" show-overflow-tooltip/>
                        <el-table-column prop="goodsName" label="报表名称" align="center" show-overflow-tooltip/>
                        <el-table-column label="报表主图" align="center">
                            <template #default="scope">
                                <el-image class="table-image" :src="scope.row.coverImg"/>
                            </template>
                        </el-table-column>
                        <el-table-column prop="stock" label="比例尺" align="center" show-overflow-tooltip/>
                        <el-table-column label="审核人员" align="center" show-overflow-tooltip>
                            <template #default="scope">
                                <span>￥{{scope.row.goodsPrice}}</span>
                            </template>
                        </el-table-column>
                        <el-table-column prop="categoryName" label="提交单位" align="center" show-overflow-tooltip/>
                        ...
                        <el-table-column label="操作" align="center" width="210">
                            <template #default="scope">
                                ...
                                <el-button type="success" size="small" round v-if="scope.row.status == 1" @click="updGoodsStatus(scope.row.goodsId,scope.row.status)">上传</el-button>
                                <el-button type="info" size="small" round v-if="scope.row.status == 0" @click="updGoodsStatus(scope.row.goodsId,scope.row.status)">下载</el-button>
...
<script>
    ...
    export default {
        setup() {
            ...
            // 添加
            const addGoodsInfo = () =>{
                router.push({ path: 'report-add', query:{type: 'add'}})
            }
