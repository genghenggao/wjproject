 ...
 * @version: v1.0.0
 * @Author: henggao
 * @Date: 2021-07-11 10:43:09
 * @LastEditors: henggao
 * @LastEditTime: 2021-07-13 15:32:10
-->
<template>
  <div class="goods-add">
    <el-card shadow="never">
      <template #header>
        <el-page-header @back="goBack" content="报表详情"></el-page-header>
      </template>
      <div class="content">
        <el-form
          :model="goodsForm"
          ...
          label-width="100px"
        >
          <el-form-item label="报表名称" prop="goodsName">
            <el-input
              class="input-size"
          ...
          <el-form-item label="报表简介" prop="goodsIntro">
            <el-input
              class="input-size"
              type="textarea"
          ...
          <el-form-item label="报表信息" prop="goodsPrice">
            <el-input-number
          ...
          <el-form-item label="报表主图" prop="coverImg">
            <el-upload
          ...
          <el-form-item label="报表轮播图" prop="carouselImg">
            <el-upload
              :action="uploadAction"
          ...
          <el-form-item label="报表详情" prop="goodsDetail">
...
export default {
  ...
  setup() {
    ...
    const rules = {
      ...
      goodsPrice: [
        { required: true, message: "请输入报表价格", trigger: "blur" },
      ],
      marketPrice: [
      ...
      goodsDetail: [
        { required: true, message: "请输入报表详情", trigger: "blur" },
      ],
    };
